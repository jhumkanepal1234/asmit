...
public class Task1 {
	...
	/*
	 * * Create a Java program and store variables to store mortgage rate and
	 * mortgage * price. First program should check if rate is higher than 4.5 user
	 * will not * buy a house, otherwise user will consider buying. Once user
